set(PACKAGE_NAME "ncJugiMapGuiDemo")
set(PACKAGE_EXE_NAME "ncjugimap_guidemo")
set(PACKAGE_VENDOR "Jugilus")
set(PACKAGE_COPYRIGHT "Copyright ©2020 ${PACKAGE_VENDOR}")
set(PACKAGE_DESCRIPTION "A nCine port of the JugiMap Gui Demo by Jugilus")
set(PACKAGE_HOMEPAGE "http://jugimap.com")
set(PACKAGE_REVERSE_DNS "com.jugimap.guidemo.ncine")
...
function(callback_start)
	if(NOT CMAKE_SYSTEM_NAME STREQUAL "Android")
		...
		if(IS_DIRECTORY ${JUGIMAP_FRAMEWORK_SRC})
			...
			file(COPY ${JUGIMAP_FRAMEWORK_SRC}/examples_c++/GuiDemo/jugiApp DESTINATION ${JUGIMAP_FRAMEWORK_DEST})
			file(COPY ${JUGIMAP_FRAMEWORK_SRC}/examples_c++/GuiDemo/GuiDemo_nCine/ DESTINATION ${JUGIMAP_FRAMEWORK_DEST})
		endif()
	endif()
endfunction()
...
function(callback_before_target)
	if(NOT CMAKE_SYSTEM_NAME STREQUAL "Android" AND IS_DIRECTORY ${PACKAGE_DATA_DIR})
		set(JUGIMAP_FRAMEWORK_SRC "${CMAKE_BINARY_DIR}/jugimap_framework-src")
		if(IS_DIRECTORY ${JUGIMAP_FRAMEWORK_SRC})
			file(COPY ${JUGIMAP_FRAMEWORK_SRC}/examples_c++/GuiDemo/media/fonts DESTINATION ${PACKAGE_DATA_DIR}/data/media)
			file(COPY ${JUGIMAP_FRAMEWORK_SRC}/examples_c++/GuiDemo/media/graphics DESTINATION ${PACKAGE_DATA_DIR}/data/media)
			file(COPY ${JUGIMAP_FRAMEWORK_SRC}/examples_c++/GuiDemo/media/maps DESTINATION ${PACKAGE_DATA_DIR}/data/media)
			file(COPY ${JUGIMAP_FRAMEWORK_SRC}/examples_c++/GuiDemo/media/texts DESTINATION ${PACKAGE_DATA_DIR}/data/media)
		endif()
		...
		file(GLOB MEDIA_MAPS RELATIVE ${PACKAGE_DATA_DIR} ${PACKAGE_DATA_DIR}/data/media/texts/*)
