...
function(callback_before_target)
	if(NOT CMAKE_SYSTEM_NAME STREQUAL "Android" AND IS_DIRECTORY ${PACKAGE_DATA_DIR})
		if(IS_DIRECTORY ${JUGIMAP_FRAMEWORK_SOURCE_DIR})
			file(COPY ${JUGIMAP_FRAMEWORK_SOURCE_DIR}/examples_c++/GuiDemo/media/fonts DESTINATION ${PACKAGE_DATA_DIR}/data/media)
			file(COPY ${JUGIMAP_FRAMEWORK_SOURCE_DIR}/examples_c++/GuiDemo/media/graphics DESTINATION ${PACKAGE_DATA_DIR}/data/media)
			file(COPY ${JUGIMAP_FRAMEWORK_SOURCE_DIR}/examples_c++/GuiDemo/media/maps DESTINATION ${PACKAGE_DATA_DIR}/data/media)
			file(COPY ${JUGIMAP_FRAMEWORK_SOURCE_DIR}/examples_c++/GuiDemo/media/texts DESTINATION ${PACKAGE_DATA_DIR}/data/media)
		endif()
